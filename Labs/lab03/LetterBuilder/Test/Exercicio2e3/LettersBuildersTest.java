...
import Excercicio2e3.Address;
import Excercicio2e3.Date;
import Excercicio2e3.EnglishFormatter;
import Excercicio2e3.FormatterAbstractFactory;
import Excercicio2e3.FriendLetter;
import Excercicio2e3.LetterBuilder;
import Excercicio2e3.Person;
...
public class LettersBuildersTest {
	...
	FormatterAbstractFactory Eformatter;
	...
	public void setUp(){
		...
		Eformatter = new EnglishFormatter();
		friendletter = new FriendLetter();
		
		Eformatter.setLetterDate(date);
		Eformatter.setLetterDestinatary(person_destinatary);
		Eformatter.setLetterDestinataryAddress(address_destinatary);
		Eformatter.setLetterSender(person_sender);
		Eformatter.setLetterSenderAddress(address_sender);
	...
	public void FriendLetter() {
		Eformatter.setLetterBuilder(friendletter);
		Eformatter.constructLetter();
		assertEquals("99 Hospital,\nZip Code:1918\nSilent Hill, Maine\n747 Spencer Mansion,\nZip Code:1914\nRacoon City, Kentucky\n6/28/1914\n\n\nDear Albert,\n\n"
				+ "<Write your message here>\n\n" + "Sincerely,\n" + "\t\t\t\tHarry",Eformatter.getLetter());
	}
}
